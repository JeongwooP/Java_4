...
//Radio
       ...
       rad1.addItemListener(this);  rad2.addItemListener(this);
       rad3.addItemListener(this);
       pn1.add(rad1);  pn1.add(rad2);  pn1.add(rad3);
      
//Choice
       cho=new Choice();
       cho.addItem("red");    cho.addItem("yellow");
       cho.addItem("blue");    cho.addItem("black");
       cho.addItemListener(this);
       pn1.add(new Label("choose color",Label.RIGHT));
       pn1.add(cho);
      
//Checkbox
       chk1=new Checkbox("Korea",true);  chk2=new Checkbox("Japen",false);
       chk3=new Checkbox("USA",false);
       pn2=new Panel();
       btnOk=new Button("Confirm");
       btnOk.addActionListener(this);
       pn2.add(new Label("Where you want to live : "));
       pn2.add(chk1);      pn2.add(chk2);
       pn2.add(chk3);      pn2.add(btnOk);
...
public void paint(Graphics g){ //프로그램 실행 시 update() -> paint()메소드 순으로 자동호출
       ...
       int x=aa.nextInt(100);     int y=aa.nextInt(100);
       int w=aa.nextInt(300);     int h=aa.nextInt(300);
       switch(sel){
             case 1:g.drawLine(x,y,w,h); break;
             case 2:g.drawOval(x,y,w,h); break;
             case 3:g.drawRect(x,y,w,h); break;
       }
}
